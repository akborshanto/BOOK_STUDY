    ...
    <div className="container mx-auto grid grid-cols-1 gap-8 lg:gap-20 md:px-10 md:pb-10 lg:grid-cols-2">
      <div className="flex flex-col items-center mx-12 lg:mx-0">
        <div className="relative text-center">
          ...
          <p className="px-6 py-1 text-lg italic">Pickering Public Library acknowledges the City of Pickering resides on land within the Treaty and traditional territory of the Mississaugas of Scugog Island First Nation and Williams Treaties signatories of the Mississauga and Chippewa Nations..</p>
        ...
        <p className='text-green-400 text-2xl'>AKBOR</p>
      </div>
      <div className="flex flex-col items-center max-w-lg mx-12 lg:mx-0">
        ...
        <span className="w-12 h-1 my-2 rounded-lg bg-violet-400"></span>
        <p className='text-green-400 text-2xl'> SHANTO</p>
      </div>
    </div>
  </section>
    </div>
